...
public class TemplateSeeder implements CommandLineRunner {
    ...
    private static final List<Starter> STARTERS = List.of(
            ...
            new Starter("AMR Robot — Shapes + Layers",
                    "The AMR architecture rebuilt from native shapes: colour-coded subsystem groups, wired end to end, with key blocks ready to drill into a level below.",
                    "Robotics", "/sample-amr-shapes.json"),
