      ...
      args: {
        ...
        markup: [
          { tagName: 'circle', selector: 'bg',
            attrs: { r: 10, fill: 'rgba(100,116,139,0.22)', stroke: 'rgba(148,163,184,0.45)',
              'stroke-width': 1, cursor: 'pointer' } },
          { tagName: 'text', selector: 'ico', textContent: 'visibility_off',
            attrs: { fill: 'rgba(100,116,139,0.85)', 'font-family': 'Material Icons', 'font-size': 11,
              'text-anchor': 'middle', 'dominant-baseline': 'central', cursor: 'pointer' } },
        ],
