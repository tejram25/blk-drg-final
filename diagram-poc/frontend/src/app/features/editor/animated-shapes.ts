...
export const ANIMATED_SYMBOLS: Record<string, AnimDef> = {
    ...
    parts: [
      ...
      { tag: 'path', attrs: { d: 'M 40 68 L 40 44', stroke: LIGHT, 'stroke-width': '6', 'stroke-linecap': 'round', fill: 'none' } },
      {
        ...
        children: [
          ...
          { tag: 'path', attrs: { d: 'M 66 24 L 75 17 M 66 24 L 76 25', stroke: '#0084D5', 'stroke-width': '3', 'stroke-linecap': 'round', fill: 'none' } },
        ],
      },
  ...
  'anim-siren': {
    width: 60, height: 56,
    parts: [
      { tag: 'path', attrs: { d: 'M 14 46 A 16 16 0 0 1 46 46 Z', fill: '#FF8674', stroke: '#FFB3A6', 'stroke-width': '1.5', class: 'anim-pulse' } },
      { tag: 'path', attrs: { d: 'M 30 22 L 30 12 M 13 32 L 4 26 M 47 32 L 56 26', stroke: '#FFC845', 'stroke-width': '2.5', 'stroke-linecap': 'round', fill: 'none', class: 'anim-pulse-alt' } },
  ...
  'anim-fan': {
    ...
    parts: [
      { tag: 'circle', attrs: { cx: '30', cy: '30', r: '26', fill: 'none', stroke: METAL, 'stroke-width': '2' } },
      {
        ...
        children: [
          { tag: 'path', attrs: { d: 'M 30 30 C 24 20 24 12 30 8 C 36 12 36 20 30 30 Z', fill: '#0084D5' } },
          { tag: 'path', attrs: { d: 'M 30 30 C 24 20 24 12 30 8 C 36 12 36 20 30 30 Z', fill: '#0084D5', transform: 'rotate(120 30 30)' } },
          { tag: 'path', attrs: { d: 'M 30 30 C 24 20 24 12 30 8 C 36 12 36 20 30 30 Z', fill: '#0084D5', transform: 'rotate(240 30 30)' } },
        ],
      },
  ...
  'anim-conveyor': {
    ...
    parts: [
      ...
      { tag: 'path', attrs: { d: 'M 15 32 L 95 32', stroke: '#0084D5', 'stroke-width': '2', 'stroke-dasharray': '6 6', fill: 'none', class: 'anim-belt' } },
      {
        tag: 'g', attrs: { class: 'anim-spin' },
  ...
  'anim-gear': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '30', cy: '30', r: '4', fill: '#0084D5' } },
    ],
    pins: [{ x: 0, y: 30 }, { x: 60, y: 30 }],
  },
  'anim-antenna': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '35', cy: '18', r: '3', fill: '#FF8674', class: 'anim-pulse' } },
      { tag: 'path', attrs: { d: 'M 43 25 A 10 10 0 0 0 43 11 M 27 25 A 10 10 0 0 1 27 11', fill: 'none', stroke: '#0084D5', 'stroke-width': '2.5', 'stroke-linecap': 'round', class: 'anim-pulse' } },
      { tag: 'path', attrs: { d: 'M 49 30 A 17 17 0 0 0 49 6 M 21 30 A 17 17 0 0 1 21 6', fill: 'none', stroke: '#0084D5', 'stroke-width': '2.5', 'stroke-linecap': 'round', class: 'anim-pulse-alt' } },
    ],
  ...
  'anim-pump': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '40', cy: '38', r: '20', fill: '#2A2A2A', stroke: METAL, 'stroke-width': '2' } },
      {
        tag: 'g', attrs: { class: 'anim-spin' },
        children: [
          { tag: 'path', attrs: { d: 'M 40 38 L 40 23 M 40 38 L 53 45 M 40 38 L 27 45', stroke: '#0084D5', 'stroke-width': '4', 'stroke-linecap': 'round', fill: 'none' } },
        ],
      },
  ...
  'anim-stack-light': {
    ...
    parts: [
      ...
      { tag: 'rect', attrs: { x: '12', y: '14', width: '20', height: '12', fill: '#FF8674', class: 'anim-cycle-1' } },
      { tag: 'rect', attrs: { x: '12', y: '26', width: '20', height: '12', fill: '#FFC845', class: 'anim-cycle-2' } },
      { tag: 'rect', attrs: { x: '12', y: '38', width: '20', height: '12', fill: '#47D7AC', class: 'anim-cycle-3' } },
      { tag: 'rect', attrs: { x: '12', y: '14', width: '20', height: '36', fill: 'none', stroke: '#2A2A2A', 'stroke-width': '1.5' } },
    ],
    ...
    parts: [
      {
        ...
        children: [
          ...
          { tag: 'rect', attrs: { x: '38', y: '20', width: '9', height: '20', fill: '#0084D5', rx: '1.5' } },
        ],
      },
  ...
  'anim-tank': {
    width: 60, height: 70,
    parts: [
      { tag: 'rect', attrs: { x: '12', y: '28', width: '36', height: '32', fill: '#0084D5', opacity: '0.75', class: 'anim-level' } },
  ...
  'anim-drone': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '40', cy: '38', r: '2.5', fill: '#0084D5' } },
      {
        tag: 'g', attrs: { class: 'anim-spin' },
  ...
  'anim-glow-battery': {
    width: 70, height: 44,
    parts: [
      { tag: 'rect', attrs: { x: '6', y: '8', width: '54', height: '28', rx: '5', fill: 'none', stroke: '#47D7AC', 'stroke-width': '2', opacity: '0.4', class: 'anim-pulse' } },
      ...
      { tag: 'rect', attrs: { x: '13', y: '15', width: '10', height: '14', fill: '#47D7AC', class: 'anim-charge-1' } },
      { tag: 'rect', attrs: { x: '27', y: '15', width: '10', height: '14', fill: '#47D7AC', class: 'anim-charge-2' } },
      { tag: 'rect', attrs: { x: '41', y: '15', width: '10', height: '14', fill: '#47D7AC', class: 'anim-charge-3' } },
    ],
  ...
  'anim-inverter': {
    ...
    parts: [
      ...
      { tag: 'rect', attrs: { x: '10', y: '10', width: '60', height: '40', rx: '4', fill: '#2A2A2A', stroke: METAL, 'stroke-width': '2' } },
      ...
      { tag: 'path', attrs: { d: 'M 44 40 Q 49 30 54 40 Q 59 50 64 40', stroke: '#0084D5', 'stroke-width': '2.5', 'stroke-dasharray': '4 4', fill: 'none', class: 'anim-belt' } },
    ],
    pins: [{ x: 0, y: 30 }, { x: 80, y: 30 }],
  },
  'anim-transformer': {
    ...
    parts: [
      ...
      { tag: 'path', attrs: { d: 'M 40 7 A 6 4 0 0 1 50 7', stroke: '#0084D5', 'stroke-width': '2', fill: 'none', 'stroke-linecap': 'round', class: 'anim-pulse' } },
      { tag: 'path', attrs: { d: 'M 40 53 A 6 4 0 0 0 50 53', stroke: '#0084D5', 'stroke-width': '2', fill: 'none', 'stroke-linecap': 'round', class: 'anim-pulse-alt' } },
    ],
  ...
  'anim-solar': {
    width: 80, height: 60,
    parts: [
      { tag: 'circle', attrs: { cx: '62', cy: '11', r: '6', fill: '#FFC845', class: 'anim-pulse' } },
      { tag: 'path', attrs: { d: 'M 62 3 L 62 1 M 54 6 L 52.5 4.5 M 70 6 L 71.5 4.5', stroke: '#FFC845', 'stroke-width': '2', 'stroke-linecap': 'round', fill: 'none', class: 'anim-pulse-alt' } },
      { tag: 'path', attrs: { d: 'M 16 24 L 64 24 L 72 44 L 8 44 Z', fill: '#0069AB', stroke: METAL, 'stroke-width': '2' } },
      { tag: 'path', attrs: { d: 'M 31 24 L 28 44 M 47 24 L 49 44 M 12 34 L 68 34', stroke: '#7FC2E8', 'stroke-width': '1', fill: 'none' } },
  ...
  'anim-wind-turbine': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '35', cy: '26', r: '3', fill: '#0084D5' } },
    ],
  ...
  'anim-generator': {
    ...
    parts: [
      ...
      { tag: 'circle', attrs: { cx: '35', cy: '30', r: '22', fill: '#2A2A2A', stroke: METAL, 'stroke-width': '2' } },
      {
        tag: 'g', attrs: { class: 'anim-spin-slow' },
        children: [{ tag: 'path', attrs: { d: 'M 35 14 L 35 46 M 19 30 L 51 30 M 24 19 L 46 41 M 46 19 L 24 41', stroke: '#0084D5', 'stroke-width': '3', 'stroke-linecap': 'round', fill: 'none' } }],
      },
  ...
  'anim-ev-charger': {
    width: 60, height: 70,
    parts: [
      { tag: 'rect', attrs: { x: '14', y: '10', width: '28', height: '52', rx: '4', fill: '#2A2A2A', stroke: METAL, 'stroke-width': '2' } },
      { tag: 'rect', attrs: { x: '20', y: '16', width: '16', height: '10', fill: '#0084D5', opacity: '0.7' } },
      { tag: 'path', attrs: { d: 'M 30 32 L 24 44 L 29 44 L 26 56 L 36 42 L 30 42 L 34 32 Z', fill: '#FFC845', class: 'anim-pulse' } },
  ...
  'anim-pylon': {
    ...
    parts: [
      ...
      { tag: 'path', attrs: { d: 'M 0 36 Q 12 42 24 34 M 56 34 Q 68 42 80 36', stroke: '#0084D5', 'stroke-width': '2', 'stroke-dasharray': '5 5', fill: 'none', class: 'anim-belt' } },
    ],
  ...
  'anim-heater': {
    ...
    parts: [
      ...
      { tag: 'path', attrs: { d: 'M 16 14 L 16 36 M 25 14 L 25 36 M 34 14 L 34 36 M 43 14 L 43 36 M 52 14 L 52 36', stroke: '#FF8674', 'stroke-width': '4', 'stroke-linecap': 'round', fill: 'none', class: 'anim-glow' } },
    ],
  ...
  'anim-bulb': {
    width: 50, height: 60,
    parts: [
      { tag: 'circle', attrs: { cx: '25', cy: '22', r: '17', fill: '#FFE3A6', opacity: '0.3', class: 'anim-pulse' } },
      { tag: 'circle', attrs: { cx: '25', cy: '22', r: '12', fill: 'none', stroke: METAL, 'stroke-width': '2' } },
      { tag: 'path', attrs: { d: 'M 19 26 L 22 19 L 25 26 L 28 19 L 31 26', stroke: '#E0A62F', 'stroke-width': '2', 'stroke-linecap': 'round', fill: 'none', class: 'anim-glow' } },
