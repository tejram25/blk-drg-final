...
${err.toString()}`);
  ...
  function createCore() {
    ...
    return {
      ...
      stateVector: () => toB64(encodeStateVector(doc2)),
      encodeUpdate: (svB64) => toB64(encodeStateAsUpdate(doc2, svB64 ? fromB64(svB64) : void 0)),
      applyRemote: (updB64) => {
        applyUpdate(doc2, fromB64(updB64), "remote");
  ...
  if (typeof globalThis !== "undefined") {
    ...
    globalThis.createCollabCore = createCore;
  }
})();
